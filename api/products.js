...
router.post('/', async (req, res) => {
  try {
    ...
    const result = await db.query(
      'INSERT INTO products (name, selling_price_dzd, cost_price_dzd, stock_quantity, supplier_id) VALUES ($1, $2, $3, $4, $5) RETURNING *',
...
router.put('/:id', async (req, res) => {
  try {
    ...
    const { name, selling_price_dzd, cost_price_dzd, stock_quantity, supplier_id } = req.body;
    await db.query(
      'UPDATE products SET name = $1, selling_price_dzd = $2, cost_price_dzd = $3, stock_quantity = $4, supplier_id = $5 WHERE id = $6',
